...
Cypress.Commands.add("triggerNotifications", () => {
  ...
  for (let i = 4; i >= 0; i--) {
    cy.exec('python cypress/python/mocklot.py put mocklot --spots ' + i)
  }
  cy.exec('python cypress/python/mocklot.py put mocklot --spots 6')
})
...
describe('Browser notifications', () => {
  ...
  beforeEach(() => {
    // Reset the mock lot.
    cy.exec('python cypress/python/mocklot.py init mocklot --spots 4')
  })
