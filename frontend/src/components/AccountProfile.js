          ...
          <Container style={{ width: "800px", }}>
            <Container className="user-banner">
              <div className="icon-border">
                <img src={`${process.env.PUBLIC_URL}/images/defaulticon.png`} alt="Profile icon" className="user-icon"></img>
              </div>
            </Container>
            <Container className="profile-settings">
              <div className="user-opts">
                <div>CURRENT CAR SIZE: {carSize}</div>
              </div>
              ...
              <div className="user-opts">
                <div>PREFFERED LOT TYPE: {lotType}</div>
              </div>
              ...
              <div className="user-opts">
                <div>PRICING OPTION: {priceType}</div>
              </div>
