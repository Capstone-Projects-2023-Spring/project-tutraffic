...
def convertToJson(array):
	convertData = {"arrayOfParkingLines": array}
	newJson = json.dumps(convertData, cls=NumpyArrayEncoder)
	return newJson
...
def main():
	...
	print(toSend)
	upload('ParkingLotLines',os.path.abspath(toSend),'parking-test-bucket')
